@echo off
set CONNECTION=Server=ABARTOLON;Database=DFLSAI;Integrated Security=True;TrustServerCertificate=True;MultipleActiveResultSets=True;Application Name=EntityFramework

REM Ejecutar desde la raiz de la solucion DflPosUpdaterCapas.
REM Genera el DbContext en App.DAL y las entidades SITES/MA_CODE en App.Entities.
